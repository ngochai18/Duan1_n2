    ...
    <div class="khung_add" style="height: 2550px;">
        ...
        <form action="index.php?act=addsp" method="post" enctype="multipart/form-data">
           ...
           <div class="Nhap_ten_sp">
            ...
            <br>
            <input type="text" class="import" name="name_sp" require>
           </div>
           ...
           <label for="" >
            ...
            <br>
            <input type="number" class="import" name="price_sp" min="0" require>
           </div>
           ...
           <label for="" >
            ...
            <br>
            <input type="file" class="import" name="img_sp" require>
           </div>
           <div class="Nhap_mota_sp" style="height: 50px !important;">
            <label for="">
                Mô tả sản phẩm : 
                <br>
                <textarea name="mota_sp" id="ykien"  cols="165" rows="30" require></textarea>
